  ...
  <div class="login">
    <div class="login__form">
      <form v-on:submit.prevent="login()">
        ...
        <input v-model="input.username" type="text" placeholder="Nom d'utilisateur" required="" />
        <input v-model="input.password" type="password" placeholder="Mot de passe" />
        <button type="submit">Se connecter</button>
      </form>
      <router-link to="/register/professional"
        >Pas de compte ? Je veux m'inscrire !</router-link
      >
    </div>
  </div>
</template>
